...
namespace TicketingSystem.Migrations
{
    ...
    [Migration("20241014134434_SetupDependenciesTable")]
    partial class SetupDependenciesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "TicketDependenciesEnum", "ticket_dependencies_enum", new[] { "sf_in_progress", "sf_resolved" });
            ...
            modelBuilder.Entity("TicketingSystem.Common.Models.Entities.TicketDependenciesEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TicketingSystem.Common.Models.Entities.TicketMetadata", b =>
                {
                    ...
                    b.HasOne("TicketingSystem.Common.Models.Entities.TicketEntity", "Ticket")
                        .WithMany("Metadata")
                        .HasForeignKey("TicketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
